<?php
namespace Fusion_Addons10\Plugin;
 ...
 * @author Fusion_Addons10 <hi@fusion10.io>
 */
					...
					<form method="post" class="tan-plugin-deactivation-survey-form">
						...
						<div class="tan-plugin-dsm-header">
							<h3 class="tan-heading">
								<?php printf( __( 'We\'re so sorry to see you go, %s!', 'fusion10' ), $user->display_name ); ?>
							</h3>
							<p class="tan-heading"><?php _e( 'Would you mind telling us why you are deactivating so we can improve it? 🤔', 'fusion10' ) ?></p>
						</div>
						...
						<div class="tan-plugin-dsm-footer">
							<a href="" class="button tan-plugin-dsm-skip-btn"><?php _e( 'Skip & Deactivate', 'fusion10' ) ?></a>
							<div class="tan-plugin-dsm-submit">
								<button class="button tan-plugin-dsm-btn tan-plugin-dsm-close"><?php _e( 'Cancel', 'fusion10' ) ?></button>
								&nbsp;
								<button class="button button-primary tan-plugin-dsm-btn tan-plugin-dsm-submit" type="submit"><?php _e( 'Submit & Deactivate', 'fusion10' ) ?></button>
							</div>
						</div>
					</form>
				</div>
				<div class="tan-plugin-deactivation-survey-img">
					<p class="tan-desc tan-consent-label" data-desc="<?php _e( 'It includes your name, email, site URL and the input you give here.', 'fusion10' ); ?>"><?php _e( 'What data we collect', 'fusion10' ); ?></p>
