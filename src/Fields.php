...
abstract class Fields extends Base {
	...
	public function enqueue_scripts() {
        ...
        wp_enqueue_style( 'fusion10-product-fields', plugins_url( 'assets/css/fields.css', __FILE__ ), [], '' );
        wp_enqueue_script( 'fusion10-product-fields', plugins_url( 'assets/js/fields.js', __FILE__ ), [ 'jquery' ], '', true );
    }
